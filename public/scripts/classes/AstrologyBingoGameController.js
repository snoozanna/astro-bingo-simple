...
celebs.map((celeb)=> {
  ...
  static catchPhraseDict = deepFreeze({
    ...
    Rising: {
      Aries: "Warrior 1, Aries Rising",
      Taurus: "Quaff a Reisling, Taurus Rising",
      Gemini: "Personality will Multiply, Gemini Rising",
      Cancer: "Crabbies Ginger Ale, Cancer Rising",
      Leo: "Teenage Simba, Leo Rising",
      Virgo: "Loves Organising, Virgo Rising",
      Libra: "Always smizing, Libra Rising",
      Scorpio: "Moody Swamp, Scorpio Rising",
      Sagittarius: "I need to leave the country, Sagittarius Rising",
      Capricorn: "Elevator to the penthouse, Capricorn Rising",
